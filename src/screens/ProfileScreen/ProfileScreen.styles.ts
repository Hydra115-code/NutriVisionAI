...
export const makeStyles = (sc: (n: number) => number) => StyleSheet.create({
  ...
  avatarText: { fontSize: sc(32), fontWeight: 'bold' },
  userName: { fontSize: sc(28), fontWeight: 'bold', marginBottom: 4 },
  userSub: { fontSize: sc(14) },
  ...
  alertLabel: { fontSize: sc(10), fontWeight: 'bold', letterSpacing: 1.5, marginBottom: 2 },
  alertValue: { fontSize: sc(18), fontWeight: 'bold' },
  ...
  statLabel: { fontSize: sc(10), fontWeight: 'bold', letterSpacing: 1, color: '#94a3b8', marginBottom: 4, textAlign: 'center' },
  statValue: { fontSize: sc(14), fontWeight: 'bold', textAlign: 'center' },

  themeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  themeLabel: { flex: 1, marginLeft: 12, fontSize: sc(16), fontWeight: '600' },
