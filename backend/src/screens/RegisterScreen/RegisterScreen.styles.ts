...
export const styles = StyleSheet.create({
  ...
  stepText: { textAlign: 'center', fontWeight: '600', marginBottom: 8, fontSize: 12 },
  ...
  iaButtonTitle: { fontWeight: 'bold', fontSize: 14, textAlign: 'center', marginBottom: 4 },
  iaButtonSub: { fontSize: 10, textAlign: 'center' },
  
  formCard: { borderRadius: 24, padding: 24, borderWidth: 1, marginBottom: 24 },
  formTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 24 },
  ...
  termsText: { flex: 1, marginLeft: 12, fontSize: 12, lineHeight: 18 },
  ...
  mainButtonText: { color: '#0f172a', fontWeight: 'bold', fontSize: 18 },
